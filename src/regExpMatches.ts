...
export const REG_EXP_MATCH = {
  ...
  LAB: new RegExp(
    `^hwb\\(\\s*${REG_EXP_0_TO_100_PERCENT}?${REG_EXP_SPACE_SEPARATOR}${REG_EXP_N128_TO_127}${REG_EXP_SPACE_SEPARATOR}${REG_EXP_N128_TO_127}(?:${REG_EXP_SLASH_SEPARATOR}(?:(?:${REG_EXP_0_TO_100_PERCENT})|(?:${REG_EXP_0_TO_1_FRACTION})))?\\s*\\)$`,
    'i',
  ),
  LCH: new RegExp(
    `^hwb\\(\\s*${REG_EXP_0_TO_100_PERCENT}?${REG_EXP_SPACE_SEPARATOR}${REG_EXP_0_TO_100_PERCENT}?${REG_EXP_SPACE_SEPARATOR}${REG_EXP_ANGLE}(?:${REG_EXP_SLASH_SEPARATOR}(?:(?:${REG_EXP_0_TO_100_PERCENT})|(?:${REG_EXP_0_TO_1_FRACTION})))?\\s*\\)$`,
    'i',
  ),
}
